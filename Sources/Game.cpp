...
void Update()
{
    ...
    // スコアの描画
    SetFont("nicoca_v1.ttf", 70.0f);
    DrawText(FormatString("%02d", score), Vector2(-319, 180), Color::black);//HW15A213 山本 裕生
    DrawText(FormatString("%02d", score), Vector2(-320, 181), Color::white);//HW15A213 山本 裕生
}
